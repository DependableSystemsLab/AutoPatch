...
The process is almost the same as before and only the two final steps (i.e., *Adding AutoPatch Workspace* and *Flash and Execute*) are different. We provided a folder named [PCEvaluation](PCEvaluation), which contains **4 main files**:
