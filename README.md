...
- Add hotpatch object file (located in \~/AutoPatch/Testcases/CVE_Lists/Results/Hotpatch_CVE_{CVEid}.o) to AutoPatchMain source code folder (e.g., src/LocalPatches/).
