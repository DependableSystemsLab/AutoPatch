...
Also, please check the directory of the variables used in the scripts, and make sure they are correct for your PC. For instance, please make sure `AUTOPATCH_INSTRUMENT_REPO` and `AUTOPATCH_ANALYSIS_REPO` is set to the folder that contains our LLVM Passes (Default: `~/AutoPatchWorkspace/Passes/`)
