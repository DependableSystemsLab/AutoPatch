...
AUTOPATCH_ANALYSIS_REPO=~/AutoPatchWorkspace/Passes/AutoPatchSecondPass #Includes AutoPatch source code
...
HOTPATCH_DIRECTORY=~/AutoPatchWorkspace/Testcases/Results/Hotpatch_CVE_${CVEid}.ll #Includes CVEs
