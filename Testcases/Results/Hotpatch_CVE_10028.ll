...
entry1:                                           ; preds = %entry
  ...
  %21 = load i32*, i32** %gpio_enable_callback_ptr, align 8, !dbg !26
...
!2 = !DIFile(filename: "Testcases/CVE-Lists/CVE-2020-10028(auto)/patchedFunc.c", directory: "~/AutoPatch")
...
!7 = !DIFile(filename: "~/AutoPatch/Testcases/CVE-Lists/CVE-2020-10028(auto)/patchedFunc.c", directory: "~/AutoPatch/Scripts")
!8 = !{}
!9 = !{!10}
...
!29 = !DILocation(line: 17, column: 32, scope: !27)
